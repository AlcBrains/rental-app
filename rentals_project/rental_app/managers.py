...
class ReservationManager(models.Manager):
    ...
    def get_queryset(self):
        return self.get_data().annotate(prev_res_id=Subquery(self.with_prev_reservation_id()))
    ...
    def with_prev_reservation_id(self):
        ...
        return self.get_data().filter(rental=OuterRef("rental"), checkin__lt=OuterRef("checkin")).order_by("-checkin").values("pk")
